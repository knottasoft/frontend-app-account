...
import ColapseNav from './AccordionNav';
...
class MobileAccountSettingsPage extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="page__account-settings container-fluid py-4 px-0">
...
MobileAccountSettingsPage.contextType = AppContext;

MobileAccountSettingsPage.propTypes = {
...
MobileAccountSettingsPage.defaultProps = {
  loading: false,
  loaded: false,
  loadingError: null,
  siteLanguage: null,
